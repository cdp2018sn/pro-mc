...
-- 7. Créer la fonction d'authentification sécurisée
...
-- 8. Créer la fonction pour hacher et insérer un utilisateur
...
-- 11. Tester l'authentification
SELECT 'Test authentification admin:' as test;
SELECT * FROM authenticate_user('abdoulaye.niang@cdp.sn', 'Passer');

-- 12. Vérifier que l'admin existe
SELECT 'Vérification admin:' as verification;
